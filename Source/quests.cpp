...
void InitQuests()
{
	...
	if (gbMaxPlayers == 1) {
		...
		quests[QuestGroup1[xrandom(0, sizeof(QuestGroup1) / sizeof(int))]]._qactive = 0;
		quests[QuestGroup2[xrandom(0, sizeof(QuestGroup2) / sizeof(int))]]._qactive = 0;
		quests[QuestGroup3[xrandom(0, sizeof(QuestGroup3) / sizeof(int))]]._qactive = 0;
		quests[QuestGroup4[xrandom(0, sizeof(QuestGroup4) / sizeof(int))]]._qactive = 0;
	}
#ifdef _DEBUG
	if (questdebug != -1)
