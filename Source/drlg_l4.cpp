...
void L4AddWall()
{
	...
	for (j = 0; j < 40; j++) {
		for (i = 0; i < 40; i++) {
			...
			if (dungeon[i][j] == 10 && xrandom(0, 100) < 100) {
				x = L4HWallOk(i, j);
				if (x != -1) {
					L4HorizWall(i, j, x);
				}
			}
			if (dungeon[i][j] == 12 && xrandom(0, 100) < 100) {
				x = L4HWallOk(i, j);
				if (x != -1) {
					L4HorizWall(i, j, x);
				}
			}
			if (dungeon[i][j] == 13 && xrandom(0, 100) < 100) {
				x = L4HWallOk(i, j);
				if (x != -1) {
					L4HorizWall(i, j, x);
				}
			}
			if (dungeon[i][j] == 15 && xrandom(0, 100) < 100) {
				x = L4HWallOk(i, j);
				if (x != -1) {
					L4HorizWall(i, j, x);
				}
			}
			if (dungeon[i][j] == 16 && xrandom(0, 100) < 100) {
				x = L4HWallOk(i, j);
				if (x != -1) {
					L4HorizWall(i, j, x);
				}
			}
			if (dungeon[i][j] == 21 && xrandom(0, 100) < 100) {
				x = L4HWallOk(i, j);
				if (x != -1) {
					L4HorizWall(i, j, x);
				}
			}
			if (dungeon[i][j] == 22 && xrandom(0, 100) < 100) {
				x = L4HWallOk(i, j);
				if (x != -1) {
					L4HorizWall(i, j, x);
				}
			}
			if (dungeon[i][j] == 8 && xrandom(0, 100) < 100) {
				y = L4VWallOk(i, j);
				if (y != -1) {
					L4VertWall(i, j, y);
				}
			}
			if (dungeon[i][j] == 9 && xrandom(0, 100) < 100) {
				y = L4VWallOk(i, j);
				if (y != -1) {
					L4VertWall(i, j, y);
				}
			}
			if (dungeon[i][j] == 11 && xrandom(0, 100) < 100) {
				y = L4VWallOk(i, j);
				if (y != -1) {
					L4VertWall(i, j, y);
				}
			}
			if (dungeon[i][j] == 14 && xrandom(0, 100) < 100) {
				y = L4VWallOk(i, j);
				if (y != -1) {
					L4VertWall(i, j, y);
				}
			...
			if (dungeon[i][j] == 23 && xrandom(0, 100) < 100) {
				y = L4VWallOk(i, j);
				if (y != -1) {
					L4VertWall(i, j, y);
				}
...
void L4firstRoom()
{
	...
	rndx = xrandom(0, 19 - w - ((20 - w) >> 1) + 1) + ((20 - w) >> 1);
	if (rndx + w > 19) {
		x = 19 - w + 1;
	} else {
		x = rndx;
	}
	rndy = xrandom(0, 19 - h - ((20 - h) >> 1) + 1) + ((20 - h) >> 1);
	if (rndy + h > 19) {
		y = 19 - h + 1;
	} else {
		y = rndy;
...
void L4roomGen(int x, int y, int w, int h, int dir)
{
	...
	case TRUE:
		num = 0;
		do {
			width = (xrandom(0, 5) + 2) & ~1;
			height = (xrandom(0, 5) + 2) & ~1;
			rx = w / 2 + x - width / 2;
			ry = y - height;
